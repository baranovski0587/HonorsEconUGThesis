...
\section{Replication}
This analysis relies on the Restricted--Use Vital Statistics Data from the Centers for Disease Control and Prevention. Access to this data can be obtained by following the instructions found here: \cite{nchsRestrictedData2021}. Other public data and my code can be found \href{https://github.com/baranovski0587/HonorsEconUGThesis}{here}.
\newpage
\section{Appendix}
\appendix
